...
> [DI(Dependency Injection)에 대해](#di(dependency-injection)에-대해)     
> [@SpringBootApplication에 대해](#@springbootapplication에-대해)     
> [@Resource, @Autowired, @inject의 차이에 대해](#@resource,-@autowired,-@inject의-차이에-대해)     
> [Spring 애플리케이션 API 요청을 처리하는 과정에 대해](#spring-애플리케이션-api-요청을-처리하는-과정에-대해)     
> [DispatcherServlet에 대해](#dispatcherservlet에-대해)     
> [트랜잭션에 대해](#트랜잭션에-대해)     
> [ACID중 Consistency(일관성)에 대해](#acid중-consistency(일관성)에-대해)     
